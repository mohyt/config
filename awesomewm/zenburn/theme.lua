...
-- {{{ Icons
-- {{{ Taglist
theme.taglist_squares_sel   = "/usr/local/share/awesome/themes/zenburn/taglist/squarefz.png"
theme.taglist_squares_unsel = "/usr/local/share/awesome/themes/zenburn/taglist/squarez.png"
